...
$(window).on('load', function() { // makes sure the whole site is loaded 
	$('#preloader').delay(9050).fadeOut(); // will first fade out the loading animation 
	$('#cssload-wrapper').delay(10050).fadeOut('slow'); // will fade out the white DIV that covers the website. 
	$('body').delay(10050).css({'overflow':'visible'});
  })
// #region Preloader
